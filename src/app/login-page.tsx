        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            ...
            <div className="text-sm">
              <Link href="/forgot-password.tsx" className="font-medium text-blue-600 hover:text-blue-500">
        ...
        >
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            <motion.button
              ...
              onClick={() => window.location.href = '/auth/facebook.tsx'}
            >
              <Facebook size={20} />
            </motion.button>
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
              onClick={() => window.location.href = '/auth/twitter.tsx'}
            >
              <Twitter size={20} />
            </motion.button>
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
              onClick={() => window.location.href = '/auth/github.tsx'}
            >
              <Github size={20} />
            </motion.button>
          </div>
